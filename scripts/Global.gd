...
var seaLevel = 2.0     # World value that ocean resets to after a storm surge
var oceanHeight = 0.0    # Current ocean level on map

var baseOceanHeight = 0.0 # Desired ocean level, independent of factors such as waves
var waveHeight = 5.0 # Max height of waves
var waveStrength = 0.05 # Rate at which waves grow/fall
